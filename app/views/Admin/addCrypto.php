    ...
    <div class="container d-flex">
        <div class="d-flex" style="flex-direction: column; width: 100%">
            ...
            <form method="post" class="d-flex justify-content-center">
                <input class="form-control" style="width: 150px; display: inline; margin-right: 10px" placeholder="Name" type="text" name="name" />
                <input class="form-control" style="width: 150px; display: inline; margin-right: 10px" placeholder="Code" type="text" name="code" />
                <input class="form-control" style="width: 150px; display: inline; margin-right: 10px" placeholder="Exchange Rate" type="text" name="exchange_rate" />
                <input class="form-control" style="width: 150px; display: inline; margin-right: 10px" placeholder="Logo Path" type="text" name="coin_logo_path" />
                <input class="btn btn-success" type="submit" name="action" value="Add Crypto" />
            </form>
        </div>
    </div>
</body>
