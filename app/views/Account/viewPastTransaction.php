        ...
        <div class="d-flex" style="flex-direction: column; width: 100%">
            ...
            <table class="d-flex table table-hover" style="display: flex; align-items: center; margin-bottom: 10px;">
                <tr style="display: flex; font-size: 17px">
                    <th style="width: 400px; display: flex">Currency Code</th>
                    <th style="width: 300px; display: flex">Amount owned</th>
                    <th style="width: 300px; display: flex">Total in CAD</th>
                    <th style="width: 300px; display: flex">Date</th>
                </tr>
                <?php if (empty($data['transactions'])) : ?>
                    <tr style="display: flex">
                        <td style="width: 100%; text-align: center" style="width: 400px; display: flex; align-items: center;">
                            <span style="font-size: 17px; font-weight: bold; margin-left: 15px; color: black">No transactions.</span>
                        </td>
                    </tr>
                <?php endif; ?>
                <?php foreach ($data['transactions'] as $transaction) : ?>
                    <tr style="display: flex">
                        <td style="width: 400px; display: flex; align-items: center;">
                            <span style="font-size: 19px; font-weight: 300; margin-left: 15px; color: rgb(93, 93, 93)"><?= $transaction->crypto_code ?></span>
                        </td>
                        <td style="width: 300px; display: flex; align-items: center;">
                            <span style="font-size: 19px; font-weight: bold; color: black"><?= $transaction->amount ?></span>
                        </td>
                        <td style="width: 300px; display: flex; align-items: center;">
                            <span style="font-size: 19px; font-weight: bold; color: black"><?= $transaction->total ?></span>
                        </td>
                        <td style="width: 300px; display: flex; align-items: center;">
                            <span style="font-size: 19px; font-weight: bold; color: black"><?= $transaction->date_time ?></span>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
