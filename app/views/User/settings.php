    ...
    <div class="container d-flex">
        <div class="d-flex" style="flex-direction: column; width: 100%">
            ...
            <div style="font-size: 22px; display: flex; flex-direction: column">
                <a style="margin-bottom: 10px; text-decoration: none" href="<?= BASE ?>/User/editPersonalInfo">Edit personal info <i class="fa fa-caret-right" aria-hidden="true"></i></a>
                <a style="margin-bottom: 10px; text-decoration: none" href="<?= BASE ?>/Account/getPastTransactions">View all transactions <i class="fa fa-caret-right" aria-hidden="true"></i></a>
                <a style="margin-bottom: 10px; text-decoration: none" href="<?= BASE ?>/Account/getReferral">Get Referral Code <i class="fa fa-caret-right" aria-hidden="true"></i></a>
                <a style="margin-bottom: 10px; text-decoration: none" href="<?= BASE ?>/Account/deleteUser">Delete my account <i class="fa fa-caret-right" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
